...
if (isset($_POST["submit"])) {
    ...
    $sqlCategory = "INSERT INTO `doctors`(`doctor_name`, `description_doctors`)  VALUES (' $name','$description')";
...
<body>
  <div class="container-scroller">
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Doctor Registration Form</h4>
            <p class="card-description">Fill out the details below to register a new doctor.</p>
            <form class="forms-sample" method = "POST">
                <div  class="form-group">
                    <label for="doctorName">Doctor Name</label>
                    <input name ="name" type="text" class="form-control" id="doctorName" placeholder="Enter doctor's name" required>
                </div>
                <div name ="des" class="form-group">
                    <label for="descriptionDoctors">Description</label>
                    <textarea name ="des" class="form-control" id="descriptionDoctors" rows="4" placeholder="Enter doctor's description" required></textarea>
                </div>
