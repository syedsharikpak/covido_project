...
$sqlInsName = "SELECT * FROM `contact_us`";
      ...
      <nav class="navbar p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <li>
              <a href="http://localhost/Project/Project%20Required/covido-master/index.php" type="button" class="btn btn-danger">Open Website</a>
              </li>
...
?>
                        <tbody id="patient-requests">
                            <tr class="patient-row">
                                <td><span class="pl-2"><?= htmlspecialchars($data['fullname']); ?></span></td>
