...
if (isset($_POST["submit"])) {
  ...
  if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
      ...
      if (move_uploaded_file($imgTmp,'uploads/' . $imgPath)) {
          ...
          $sqlCategory = "INSERT INTO `vaccine`(`img_vaccine`, `vaccine_name`, `description_vaccine`)VALUES ('$img', '$name', '$description')";
          
          if (mysqli_query($conn, $sqlCategory)) {
              echo "<script>alert('New Vaccine Inserted');</script>";
          } else {
